...
// effect as the api annotation. This can be particularly useful if you
// have a api that is reused in multiple services. Note that any transcoding
...
// api to JSON conversion must follow the [proto3
