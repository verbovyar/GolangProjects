...
// 	protoc        (unknown)
// source: google/grpcHandlers/http.apiProto
...
// `"{var=*}"`, when such a variable is expanded into a URL path on the infrastructure
...
// infrastructure side, all characters except `[-_.~/0-9a-zA-Z]` are percent-encoded.
...
// because infrastructure libraries are not capable of handling such variable expansion.
//
...
// no infrastructure library can support such complicated mapping.
//
